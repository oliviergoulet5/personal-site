...
export function Timeline({ events, setSelectedEvent }: Props) {
                ...
                <hr className="absolute w-full my-auto mt-3 border-gray-500" />
                {
                    events.map((e, i) => {
                        return <div 
                            ...
                            className="cursor-pointer w-8 h-8 p-1 rounded-full border-2 border-gray-500 hover:border-gray-400 z-10 bg-gray-800">
                                { iconMap[e.type] }
